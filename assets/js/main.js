(function () {
  ...
  const translations = {
    'zh-CN': {
      ...
      'hero.description': '在<span class="highlight">邱锡鹏</span>教授的带领下，OpenMOSS Lab 推进跨越语言、多模态智能和具身智能体的大规模 AI 系统研究。我们设计开源模型、工具和理论，将 AI 与现实世界影响相结合。',
      'hero.cta1': '加入我们',
      'hero.cta2': '最新亮点',
      'hero.focus.title': '我们的研究重点',
      'hero.focus.item1': '开源基础模型',
